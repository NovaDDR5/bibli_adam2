...
Telecharge le fichier "bibli_adam_64bit_html-0.0.4.tar.gz" dans le dossier "dist" et extrait le avec winrar (https://www.win-rar.com/) ou 7-zip (https://7-zip.org/). Les modules d'encodage 64bit et HTML sont à l'interieur du dossier "my_package" dans deux fichiers differents avec une documentation chacun dans leurs dossier respectifs (module1 --> 64bit / module2 --> HTML).
